...
- Free talent: C16 family CLOSED PARTIAL — need mechanism ≠ dual-inject+decay / port-seed / local scaffold; C26 latch-tau **FAILED** hard-cap; C27–C34 NULL families (pair/triad decay, speed, atom_repulsion, n_emit, r_1, PRIM7 sideband cull, r_2)  
