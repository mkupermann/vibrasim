"""BP-E141 cascade coincidence AND multi-hop soft dual wipe-restore. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3781,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E141 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*164217+ti*971)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E141"; out.mkdir(parents=True,exist_ok=True)
