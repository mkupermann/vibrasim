"""BP-E93 soft DEMUX full restore then hard re-cut arm0. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((2701,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E93 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*116153+ti*619)
