"""BP-E136 coincidence AND hard dual wipe, restore L2 only then L1. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3681,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E136 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*159217+ti*937)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E136"; out.mkdir(parents=True,exist_ok=True)
