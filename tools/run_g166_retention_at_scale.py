"""G166 — retention at scale: 24-bit register × kick agitation.

Pre-registered in docs/amendments/g166_retention_at_scale.md (all round-table
...
Usage: python tools/run_g166_retention_at_scale.py
...
CENSUS_EVERY = 1_000
WINDOW = 12.0
OUT_DIR = Path(__file__).resolve().parent.parent / "archive" / "run-logs" / "g166"
