"""BP-E131 coincidence AND soft dual wipe, restore L1 only then L2. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3581,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E131 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*154217+ti*887)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E131"; out.mkdir(parents=True,exist_ok=True)
