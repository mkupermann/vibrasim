"""BP-E105 soft 2x2 full restore then soft-cut identity diagonal 00+11. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3001,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E105 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*128197+ti*701)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E105"; out.mkdir(parents=True,exist_ok=True)
