"""BP-E143 cascade AND hard dual wipe, selective L1 restore then L2. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3861,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E143 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*166217+ti*983)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E143"; out.mkdir(parents=True,exist_ok=True)
