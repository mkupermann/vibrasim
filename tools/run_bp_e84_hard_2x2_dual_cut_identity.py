"""BP-E84 hard 2x2 dual-kill all arms then selective identity restore. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((2521,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E84 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*107113+ti*571)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E84"; out.mkdir(parents=True,exist_ok=True)
