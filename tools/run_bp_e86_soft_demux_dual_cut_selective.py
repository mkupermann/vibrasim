"""BP-E86 soft DEMUX dual-cut all then selective arm restore. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((2561,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E86 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*109131+ti*587)
