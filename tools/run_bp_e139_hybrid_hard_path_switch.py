"""BP-E139 hybrid hard multi-trial path-switch OR-AND-OR. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3741,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E139 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*162217+ti*953)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E139"; out.mkdir(parents=True,exist_ok=True)
