"""BP-E58 three-path hard MUX curriculum. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((1681,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E58 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*81031+ti*397)
