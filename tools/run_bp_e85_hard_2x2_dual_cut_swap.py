"""BP-E85 hard 2x2 dual-kill all arms then selective swap restore. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((2541,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E85 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*108127+ti*577)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E85"; out.mkdir(parents=True,exist_ok=True)
