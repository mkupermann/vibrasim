"""BP-E97 soft MUX wide y-sep full restore + soft re-cut path0. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((2781,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E97 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*120167+ti*647)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E97"; out.mkdir(parents=True,exist_ok=True)
