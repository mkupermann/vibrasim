"""BP-E60 hard 2x2 crossbar identity/swap curriculum. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((1771,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E60 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*83037+ti*409)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E60"; out.mkdir(parents=True,exist_ok=True)
