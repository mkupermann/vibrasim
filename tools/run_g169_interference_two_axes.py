"""G169 — interference re-certification: two axes + mechanism point prediction.

Pre-registered in docs/amendments/g169_interference_two_axes.md.
Metrics only; verdict against the frozen bars.

Usage: python tools/run_g169_interference_two_axes.py   (resumable per arm)
...
CENSUS_EVERY = 1_000
WINDOW = 12.0
OUT_DIR = Path(__file__).resolve().parent.parent / "archive" / "run-logs" / "g169"
