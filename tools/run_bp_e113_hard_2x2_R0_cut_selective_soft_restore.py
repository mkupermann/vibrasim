"""BP-E113 hard dual-cut R0 then selective soft restore 00 only. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3181,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E113 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*136217+ti*769)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E113"; out.mkdir(parents=True,exist_ok=True)
