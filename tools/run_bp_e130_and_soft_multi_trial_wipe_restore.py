"""BP-E130 coincidence AND multi-trial soft wipe-restore cycle. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3561,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E130 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*153217+ti*883)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E130"; out.mkdir(parents=True,exist_ok=True)
