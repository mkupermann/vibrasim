"""BP-E54 hard mid kill r=12 of L-A-B-R + full three-hop restore. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((1601,),3) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E54 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*77017+ti*373)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E54"; out.mkdir(parents=True,exist_ok=True)
