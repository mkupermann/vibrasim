"""BP-E135 coincidence AND multi-trial hard dual wipe selective L1 re-arm. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3661,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E135 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*158217+ti*929)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E135"; out.mkdir(parents=True,exist_ok=True)
