"""BP-E89 hard 3-path MUX dual-kill all then selective path restore. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((2621,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E89 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*112141+ti*601)
