"""BP-E70 hard-kill OR bypass of AND-OR hybrid. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((2061,),3) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E70 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*93071+ti*467)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E70"; out.mkdir(parents=True,exist_ok=True)
