"""BP-E114 soft 2x2 identity-diag cut then dual restore 00+11. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3201,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E114 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*137217+ti*773)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E114"; out.mkdir(parents=True,exist_ok=True)
