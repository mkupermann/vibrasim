"""BP-E52 mid soft-cut of L-A-B-R, full three-hop restore. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((1561,),3) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E52 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*75011+ti*359)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E52"; out.mkdir(parents=True,exist_ok=True)
