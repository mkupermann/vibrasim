"""BP-E109 soft 2x2 full restore then hard-cut swap diagonal 01+10. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3081,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E109 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*132217+ti*733)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E109"; out.mkdir(parents=True,exist_ok=True)
