"""BP-E124 dual 3-hop soft wipe both, full restore, hard re-cut path0. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3401,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E124 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*147217+ti*853)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E124"; out.mkdir(parents=True,exist_ok=True)
