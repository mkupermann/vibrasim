"""BP-E112 soft 2x2 dual-cut R0 then restore BOTH 00+10. Headless."""
...
def main(argv=None):
    ...
    seeds,trials=((3161,),2) if args.smoke else (SEEDS,TRIALS)
    print(f"BP-E112 start smoke={args.smoke}")
    b1s,b2s,b3s=[],[],[]
    for seed in seeds:
        for ti in range(trials):
            rng=np.random.default_rng(seed*135217+ti*761)
    ...
    out=Path.home()/".eqmod"/"bet"/"BP-E112"; out.mkdir(parents=True,exist_ok=True)
