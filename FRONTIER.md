...
- **Substrate physics thread `gNNN`:** completed through **G151**. `ls docs/amendments/g*.md | sort` and read the
  highest few before proposing a "new" gNNN — much of G30–G151 is already done.
