...
# G26 density-by-amplitude parameters. R-22b pre-data correction
# (amendment "Pre-data correction record 2026-05-22"): K and N_MAX
# raised from 4 to 8 so the zero-injection boundary moves from
# |x|<0.125 to |x|<0.0625, lifting the substrate-starvation regime
# diagnosed in R-22 attempt 1. Locked by R-22b protocol.
DENSITY_K = 8
DENSITY_N_MAX = 8
